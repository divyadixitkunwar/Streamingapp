  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex ml-auto p-4">
        <div className="flex">
          <Link to={'/register'} className="flex-1 bg-blue-950 text-white py-2 px-4 focus:outline-none  rounded-l-xl">Register</Link>
          <Link to={'/register/login'} className="flex-1 bg-white text-black py-2 px-4 focus:outline-none hover:bg-gray-200 rounded-r-xl">Login</Link>
        </div>
      </div>
